<template>
  <div class="flex flex-col gap-6">
    ...
    <project-form v-if="can('create-project')" @submit="projects.add" />
      ...
      <template v-else>
        <div v-if="projects.list.length === 0" class="col-span-12 flex flex-col items-center gap-4 py-20 text-gray-400 dark:text-gray-600">
          ...
          <div class="text-center">
            <p class="font-['Syne'] font-bold text-[16px] text-gray-700 dark:text-gray-300 mb-1">No projects yet</p>
            <p v-if="can('create-project')" class="text-[13px]">Click "New Project" above to get started</p>
          </div>
        </div>
